...
import type { CrawlConfig, CrawledPage, CrawlProgress } from '@/types/seo/crawler'
import type { PageAnalysis, SiteAnalysis } from '@/types/seo/analysis'
import type { OrchestratorState, OrchestratorContext, OrchestratorError } from '@/types/seo/orchestrator'
import { SiteCrawler } from '@/lib/seo/crawler'
import { analyzePages } from '@/lib/seo/analyzer'
import { aggregateSiteAnalysis } from '@/lib/seo/analyzer/aggregator'
import { generateRecommendations } from '@/lib/seo/openai'
...
export class AnalysisOrchestrator extends EventEmitter<OrchestratorEvents> {
  ...
  async start(): Promise<SiteAnalysis> {
    ...
    if (this.context.config.generateAiRecommendations === true) {
